...
from SpectralNorm import spectral_norm as _spectral_norm
...
class InpaintGenerator(BaseNetwork):
    ...
    def forward(self, masked_frames):
        # extracting features
        masked_frames = masked_frames.permute(0,2,1,3,4)
        ...
        return output.view(b, t, 3, h*4, w*4).permute(0,2,1,3,4)
